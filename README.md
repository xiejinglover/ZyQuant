...
当前版本为 `2.0.2`，实现了架构文档定义的完整单机日频研究基线：
...
[GitHub Release](https://github.com/xiejinglover/ZyQuant/releases/tag/v2.0.2) 的 wheel：
...
python -m pip install \
  "https://github.com/xiejinglover/ZyQuant/releases/download/v2.0.2/zyquant-2.0.2-py3-none-any.whl"
```
...
```bash
WHEEL_URL="https://github.com/xiejinglover/ZyQuant/releases/download/v2.0.2/zyquant-2.0.2-py3-none-any.whl"
